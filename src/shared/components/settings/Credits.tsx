...
const Credits = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-180px)] pb-4 mt-0">
      <Card className="py-0 bg-transparent border-0 shadow-none rounded-0">
        <CardContent className="p-0">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              onClick={goTopUp}
              className="leading-1 bg-brand-primary text-[12px] font-normal h-6 px-4 rounded-[22px]"
            >
              Top Up
            </Button>
          </div>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <RotateCw
                ...
                onAnimationEnd={(e) =>
                  e.currentTarget.classList.remove("animate-[spin_0.6s_linear]")
                }
          ...
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-normal ">Daily refresh credits</span>
            <div className="flex items-center gap-2">
      ...
      <Card className="flex-1 py-0 bg-white rounded-[8px] mt-4 overflow-hidden">
        <CardContent className="flex flex-col p-0">
          <div className="flex items-center justify-between px-4 my-3">
            <h3 className="text-base font-normal ">History</h3>
            <span className="text-xs font-normal ">Credits not received?</span>
          </div>
          <ScrollArea className=" h-[calc(100vh-405px)] px-4">
            {history.length > 0 &&
